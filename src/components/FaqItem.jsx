  ...
  return (
    <div className="relative z-2 mb-16">
        <div className="group relative cursor-pointer items-center justify-between gap-10 px-7 " onClick={()=>{
            ...
            <div className={clsx('faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-500 transition-all duration-500 group-hover:border-s4',active && 'before:bg-p1 after:rotate-0 after:bg-p1')}>
        ...
        <div className={clsx('g5 -bottom-7 -top-7 left-0 right-0 -z-1 rounded-3xl opacity-0 transition-opacity duration-500 absolute', active && 'opacity-100')}>
            <div className="g4 absolute inset-0.5 -z-1 rounded-3xl">
                <div className="absoulte left-8 top-0 h-0.5 w-40 bg-p1"/>
            </div>
        </div>
    </div>
  )
